...
export const AdminDashboard: React.FC<DashboardProps> = ({ user, onLogout }) => {
  ...
  const [profileData, setProfileData] = useState({
    name: user.name,
    email: user.email,
    department: user.department || 'Administrative Services',
    phone: '+63 917 555 1234',
    bio: 'Administrative officer handling facility requests, student IDs, and campus logistics.'
  });
  ...
  const uniqueSubcategories = Array.from(new Set(adminTickets.map(t => t.subcategory).filter(Boolean))) as string[];

  // 2. Ticket List Filtering & Sorting - Applied to adminTickets
  ...
  const todayTickets = adminTickets.filter(t => {
    const ticketDate = new Date(t.submittedDate).toISOString().split('T')[0];
    return ticketDate === today;
  });

  const yesterdayTickets = adminTickets.filter(t => {
    const ticketDate = new Date(t.submittedDate).toISOString().split('T')[0];
  ...
  // Calculate average response time (time from submitted to first status change)
  const getAverageResponseTime = (ticketList: Ticket[]) => {
    const responseTimes = ticketList
      ...
      .map(t => {
        ...
        return Math.round((updated - submitted) / (1000 * 60)); // minutes
      });
    ...
    <div className="flex h-screen bg-white font-sans text-slate-900">
        ...
        <aside className="w-72 bg-white border-r border-slate-200 hidden md:flex flex-col h-full fixed left-0 top-0 z-10 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
            ...
            <div className="px-6 pt-8 mb-4">
                 <div className="p-5 bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100 shadow-sm">
                    <div className="flex items-center space-x-3 mb-3">
                        <div className="h-10 w-10 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold text-sm shadow-md ring-2 ring-white overflow-hidden">
                            {user.avatar ? (
                        ...
                        <div className="overflow-hidden">
                            <p className="text-xs font-bold text-blue-900 uppercase tracking-wider flex items-center gap-1">
            ...
            <nav className="flex-1 px-6 space-y-3 mt-4">
               {[
                 ...
                 { id: 'tickets', label: 'Ticket Requests', icon: TicketIcon },
                 ...
                 >
                   <item.icon className={`mr-4 h-5 w-5 ${view === item.id && !selectedTicket ? 'text-white' : 'text-slate-400 group-hover:text-blue-600'}`} />
                   {item.label}
                 </button>
               ))}
            </nav>
        ...
        <main className="flex-1 overflow-y-auto p-10 md:ml-72 bg-white min-h-screen">
                      ...
                      <div className="bg-slate-900 rounded-3xl p-8 text-white relative overflow-hidden shadow-xl mb-8">
                          ...
                          <div className="relative z-10">
                              ...
                              <p className="text-slate-300 max-w-xl">
                                  You have <span className="text-white font-bold">{pendingCount} pending</span> administrative tickets requiring your attention.
                              </p>
                              <div className="mt-6 flex gap-3">
                                  <Button onClick={() => setView('tickets')} className="bg-blue-600 hover:bg-blue-700 text-white border-none font-bold rounded-xl shadow-lg shadow-blue-500/20">
                                      Manage Requests
                                  </Button>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between px-1">
                            ...
                            <Button 
                                ...
                                className="bg-white text-blue-700 hover:bg-blue-50 border border-blue-100 px-4 py-2 rounded-lg font-bold text-xs transition-all shadow-sm hover:shadow"
                            >
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 text-white">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div className="bg-white/10 backdrop-blur rounded-xl p-4">
                                <p className="text-blue-100 text-sm font-medium mb-1">Today's Tickets</p>
                            ...
                            <div className="bg-white/10 backdrop-blur rounded-xl p-4">
                                <p className="text-blue-100 text-sm font-medium mb-1">Resolved Today</p>
                            ...
                            <div className="bg-white/10 backdrop-blur rounded-xl p-4">
                                <p className="text-blue-100 text-sm font-medium mb-1">Daily Resolution Rate</p>
                                <p className="text-3xl font-bold">{dailyResolutionRate}%</p>
                                <p className="text-xs text-blue-200 mt-1">Today's efficiency</p>
                            </div>
                            <div className="bg-white/10 backdrop-blur rounded-xl p-4">
                                ...
                                <p className="text-xs text-blue-200 mt-1">Average time to respond</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                        ...
                        <Card className="bg-white border border-slate-200 shadow-sm rounded-2xl hover:shadow-lg transition-all p-8 flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-emerald-600 font-medium mt-2 flex items-center">
                                    <TrendingUp className="h-4 w-4 mr-1" /> Very Efficient
                                </p>
                            </div>
                 ...
                 <div className="space-y-8 max-w-7xl mx-auto">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                          <div>
                              ...
                              <p className="text-slate-500 text-lg mt-2">Manage and process all administrative inquiries in real-time.</p>
                          </div>
                      </div>
                      ...
                      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col xl:flex-row justify-between gap-6 items-center sticky top-0 z-20">
                           ...
                           <div className="relative w-full xl:w-80">
                              ...
                              <Input 
                                  ...
                                  className="pl-12 py-5 text-sm rounded-xl bg-slate-50 border-slate-200 focus:bg-white focus:ring-blue-500 focus:border-blue-500 w-full transition-all"
                                      ...
                                      <div className="flex flex-col md:flex-row gap-4 md:items-center justify-between">
                                          <div className="space-y-2">
                                              <div className="flex items-center flex-wrap gap-2">
                                                  ...
                                                  <h3 className="font-medium text-slate-900 text-base group-hover:text-blue-700 transition-colors">{ticket.title}</h3>
                                                  <span className={`text-[10px] font-medium px-2 py-0.5 rounded-full uppercase tracking-wide flex items-center gap-1 ${
                                                      ticket.priority === 'High' ? 'bg-red-50 text-red-600 border border-red-100' :
                                                      ticket.priority === 'Medium' ? 'bg-amber-50 text-amber-600 border border-amber-100' :
                                                      'bg-blue-50 text-blue-600 border border-blue-100'
                      ...
                      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between gap-6 items-center sticky top-0 z-20">
                           <div className="relative w-full md:max-w-md">
                              ...
                              <Input 
                                  ...
                                  className="pl-12 py-4 text-base rounded-xl bg-slate-50 border-slate-200 focus:bg-white focus:ring-blue-500 focus:border-blue-500 w-full transition-all"
                                  value={searchStudent}
                               ...
                               <table className="w-full text-left">
                                   <thead className="bg-slate-50 border-b border-slate-200">
                                       <tr>
                                           ...
                                           <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider text-center">Admin Tickets</th>
                                               ...
                                               <tr key={student.id} className="hover:bg-slate-50 transition-colors">
                                                   <td className="px-6 py-4">
                                                       <div className="flex items-center space-x-3">
                                                           <div className="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold text-sm border-2 border-white shadow-sm overflow-hidden">
                                                   ...
                                                   <td className="px-6 py-4 text-right">
                                                       <Button 
                                                           ...
                                                           className="bg-white border border-slate-200 text-slate-700 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200 shadow-sm font-bold px-4"
                                                       >
                    ...
                    <Card className="overflow-hidden border border-slate-200 shadow-sm rounded-2xl">
                         <CardHeader className="bg-slate-50 border-b border-slate-100 p-8">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <CardTitle className="text-2xl font-bold text-slate-900">Admin Profile</CardTitle>
                         ...
                         <CardContent className="p-8">
                             <form onSubmit={handleProfileUpdate}>
                                <div className="flex flex-col md:flex-row gap-10 mb-8">
                                    <div className="flex flex-col items-center space-y-4 pt-2">
                                        <div className="relative group cursor-pointer" onClick={() => document.getElementById('admin-avatar-upload')?.click()}>
                                            <div className="h-40 w-40 rounded-full bg-blue-100 flex items-center justify-center text-5xl font-bold text-blue-600 border-4 border-white shadow-2xl overflow-hidden relative">
                                                {user.avatar ? (
                                                    <img src={user.avatar} alt="Profile" className="h-full w-full object-cover" />
                                                ) : (
                                            ...
                                            <button type="button" className="absolute bottom-2 right-2 p-3 bg-slate-900 text-white rounded-full shadow-lg hover:bg-blue-600 transition-colors border-4 border-white">
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <Input 
                                                        ...
                                                        className="pl-12 py-6 text-base bg-slate-50 focus:bg-white border-slate-200 focus:ring-blue-500 focus:border-blue-500 rounded-xl" 
                                                    />
                                                </div>
                                            </div>
                                            <div>
                                ...
                                <div className="flex justify-end pt-6 border-t border-slate-100">
                                    <Button type="submit" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-base font-bold rounded-xl shadow-lg shadow-blue-200 transition-transform hover:-translate-y-1" disabled={isSaving}>
                         ...
                         <CardContent className="p-8">
                             <form onSubmit={handlePasswordUpdate} className="max-w-2xl">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <Input 
                                                ...
                                                required 
                                                className="py-6 text-base rounded-xl border-slate-200 focus:ring-blue-500 pr-10"
                                            />
                                            <button
                                                type="button"
                                ...
                                <div className="pt-8 mt-4">
                                    <Button type="submit" variant="outline" className="border-slate-200 hover:bg-blue-50 hover:text-blue-700 text-base font-bold px-8 py-4 rounded-xl transition-colors" disabled={isSaving}>
                                        Update Password
                                    </Button>
                                </div>
                             </form>
                     ...
                     <div className="lg:col-span-2 space-y-8">
                          ...
                          <div className="pt-4">
                              ...
                              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                                  <textarea 
                                     className="w-full bg-white border border-slate-200 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[100px] mb-3"
                                  ...
                                  <div className="flex justify-between items-center">
                                      <div className="flex items-center">
                                         <label className="cursor-pointer p-2 text-slate-900 hover:text-blue-600 bg-slate-100 hover:bg-blue-50 rounded-full transition-colors" title="Attach file">
                                         ...
                                         {commentFile && (
                                            <div className="flex items-center gap-2 bg-blue-50 px-3 py-1 rounded-full border border-blue-100 ml-2">
                                                <span className="text-xs font-medium text-blue-700 max-w-[150px] truncate">{commentFile.name}</span>
                                                <button onClick={() => setCommentFile(null)} className="text-blue-500 hover:text-red-500">
                                                    <X className="h-3 w-3" />
                                                </button>
                                            </div>
                                         )}
                             ...
                             <CardContent className="p-4 space-y-4">
                                 <div>
                                     ...
                                     <Select
                                         ...
                                         className="w-full bg-slate-50 border-slate-200 font-medium text-slate-700 rounded-lg focus:ring-blue-500"
                                     >
            ...
            >
                {selectedStudent && (
                    <div className="space-y-6">
                        <div className="flex items-center space-x-6 mb-8 p-6 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl text-white shadow-lg relative overflow-hidden">
                        ...
                        <div className="space-y-4 max-h-[50vh] overflow-y-auto pr-2">
                            {getStudentTickets(selectedStudent.id).length > 0 ? (
                                    ...
                                    >
                                        <div className="flex justify-between items-start pr-8">
                                            <div>
                                                ...
                                                <h5 className="font-bold text-lg text-slate-900 group-hover:text-blue-600 transition-colors">{t.title}</h5>
                                        ...
                                        <div className="absolute right-5 top-1/2 -translate-y-1/2 text-slate-300 group-hover:text-blue-600 opacity-0 group-hover:opacity-100 transition-all">
                                ...
                                <div className="text-center py-12 border-2 border-dashed border-slate-100 rounded-2xl">
                                    ...
                                    <p className="text-slate-500 font-medium">No administrative tickets found for this student.</p>
                                </div>
                            )}
                        </div>
                    </div>
