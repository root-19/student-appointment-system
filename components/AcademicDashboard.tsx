...
export const AcademicDashboard: React.FC<DashboardProps> = ({ user, onLogout }) => {
  ...
  // 1. Stats - Filter strictly for Academic tickets
  const academicTickets = tickets.filter(t => t.category === 'Academic'); 
  const pendingCount = academicTickets.filter(t => t.status === 'Pending').length;
  const inProgressCount = academicTickets.filter(t => t.status === 'In Progress').length;
  const resolvedCount = academicTickets.filter(t => t.status === 'Resolved').length;

  // Extract unique subcategories for filter
  const uniqueSubcategories = Array.from(new Set(academicTickets.map(t => t.subcategory).filter(Boolean))) as string[];

  // 2. Ticket List Filtering & Sorting
  const filteredTickets = academicTickets.filter(t => {
      const matchesSearch = 
    ...
    <div className="flex h-screen bg-white font-sans text-slate-900">
      ...
      <aside className="w-72 bg-white border-r border-slate-200 hidden md:flex flex-col h-full fixed left-0 top-0 z-10 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        ...
        <div className="p-8 flex items-center space-x-4 border-b border-slate-50">
           ...
           <div>
             ...
             <span className="text-xs text-orange-600 font-bold tracking-widest mt-1 block">PORTAL</span>
           </div>
        </div>
        ...
        <div className="px-6 pt-8 mb-4">
             <div className="p-5 bg-gradient-to-br from-orange-50 to-white rounded-2xl border border-orange-100 shadow-sm">
                <div className="flex items-center space-x-3 mb-3">
                    <div className="h-10 w-10 rounded-full bg-orange-600 flex items-center justify-center text-white font-bold text-sm shadow-md ring-2 ring-white overflow-hidden">
                        {user.avatar ? (
                    ...
                    <div className="overflow-hidden">
                        <p className="text-xs font-bold text-orange-900 uppercase tracking-wider flex items-center gap-1">
        ...
        <nav className="flex-1 px-6 space-y-3 mt-4">
           {[
             ...
             >
               <item.icon className={`mr-4 h-5 w-5 ${view === item.id && !selectedTicket ? 'text-white' : 'text-slate-400 group-hover:text-orange-600'}`} />
               {item.label}
             </button>
           ))}
        </nav>
      ...
      <main className="flex-1 overflow-y-auto p-10 md:ml-72 bg-white min-h-screen">
                  ...
                  <div className="bg-slate-900 rounded-3xl p-8 text-white relative overflow-hidden shadow-xl mb-8">
                      ...
                      <div className="relative z-10">
                          ...
                          <p className="text-slate-300 max-w-xl">
                              You have <span className="text-white font-bold">{pendingCount} pending</span> academic inquiries requiring your attention.
                          </p>
                          <div className="mt-6 flex gap-3">
                              <Button onClick={() => setView('tickets')} className="bg-orange-600 hover:bg-orange-700 text-white border-none font-bold rounded-xl shadow-lg shadow-orange-500/20">
                                  Manage Requests
                              </Button>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                      ...
                      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 relative overflow-hidden group hover:shadow-md transition-all">
                          ...
                          <div className="relative z-10">
                              ...
                              <p className="text-sm font-semibold text-slate-500 uppercase tracking-wide">Total Inquiries</p>
                          </div>
                      </div>
                  ...
                  <div className="space-y-3">
                      <div className="flex items-center justify-between px-1">
                          <div>
                              ...
                              <p className="text-xs text-slate-500 mt-0.5">Latest academic inquiries and updates.</p>
                          </div>
                          <Button 
                              onClick={() => setView('tickets')}
                              className="bg-white text-orange-700 hover:bg-orange-50 border border-orange-100 px-4 py-2 rounded-lg font-bold text-xs transition-all shadow-sm hover:shadow"
                          >
                      ...
                      <Card className="border border-slate-200 shadow-lg shadow-slate-200/50 rounded-2xl overflow-hidden bg-white">
                          <div className="divide-y divide-slate-100">
                              {academicTickets.slice(0, 5).map(ticket => (
                                      ...
                                      <div className="flex flex-col md:flex-row justify-between gap-3">
                                          <div className="flex flex-col gap-1 flex-1">
                                              <div className="flex items-center gap-2 flex-wrap">
                                                  ...
                                                  <h4 className="text-sm font-bold text-slate-900 group-hover:text-orange-700 transition-colors">{ticket.title}</h4>
                                          ...
                                          <div className="flex items-center gap-2 min-w-[100px] justify-end">
                                              ...
                                              <div className="text-slate-300 group-hover:text-orange-600 transition-colors">
              ...
              <div className="space-y-10 max-w-7xl mx-auto">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                      <Card className="bg-white border border-slate-200 shadow-sm rounded-2xl hover:shadow-lg transition-all p-8 flex items-center justify-between">
                            ...
                            <div className="h-24 w-24 bg-orange-50 rounded-full flex items-center justify-center text-orange-600">
                              ...
                              <CardContent className="h-[350px]">
                                  <ResponsiveContainer width="99%" height="100%">
                                      <BarChart data={WEEKLY_DATA} barSize={40}>
                                          ...
                                          />
                                          <Bar dataKey="tickets" name="Total Tickets" fill="#ea580c" radius={[4, 4, 0, 0]} />
          ...
          {view === 'tickets' && (
              ...
              <div className="space-y-8 max-w-7xl mx-auto">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div>
                          <h1 className="text-4xl font-bold text-slate-900 tracking-tight">Academic Inquiries</h1>
                          <p className="text-slate-500 text-lg mt-2">Manage and process all student academic concerns in real-time.</p>
                      </div>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col xl:flex-row justify-between gap-6 items-center sticky top-0 z-20">
                      ...
                      <div className="relative w-full xl:w-80">
                          ...
                          <Input 
                              ...
                              className="pl-12 py-5 text-sm rounded-xl bg-slate-50 border-slate-200 focus:bg-white focus:ring-orange-500 focus:border-orange-500 w-full transition-all"
                  ...
                  <div className="grid gap-4">
                      {paginatedTickets.length > 0 ? (
                          paginatedTickets.map(ticket => (
                              <div key={ticket.id} className="group bg-white border border-slate-200 rounded-xl p-5 hover:shadow-md transition-all duration-200 hover:border-orange-300 cursor-pointer" onClick={() => setSelectedTicket(ticket)}>
                                  <div className="flex flex-col md:flex-row gap-4 md:items-center justify-between">
                                      <div className="space-y-2">
                                          <div className="flex items-center flex-wrap gap-2">
                                              ...
                                              <h3 className="font-medium text-slate-900 text-base group-hover:text-orange-700 transition-colors">{ticket.title}</h3>
                                              <span className={`text-[10px] font-medium px-2 py-0.5 rounded-full uppercase tracking-wide flex items-center gap-1 ${
                                                  ticket.priority === 'High' ? 'bg-red-50 text-red-600 border border-red-100' :
                                                  ticket.priority === 'Medium' ? 'bg-amber-50 text-amber-600 border border-amber-100' :
                                                  'bg-blue-50 text-blue-600 border border-blue-100'
                  ...
                  <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between gap-6 items-center sticky top-0 z-20">
                      <div className="relative w-full md:max-w-md">
                          ...
                          <Input 
                              ...
                              className="pl-12 py-4 text-base rounded-xl bg-slate-50 border-slate-200 focus:bg-white focus:ring-orange-500 focus:border-orange-500 w-full transition-all"
                              value={searchStudent}
                                        ...
                                        <tr key={student.id} className="hover:bg-slate-50 transition-colors">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center space-x-3">
                                                    <div className="h-10 w-10 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 font-bold text-sm border-2 border-white shadow-sm overflow-hidden">
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <Badge className="bg-orange-100 text-orange-700 hover:bg-orange-200 px-3 py-1">
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <Button 
                                                    ...
                                                    className="bg-white border border-slate-200 text-slate-700 hover:bg-orange-50 hover:text-orange-700 hover:border-orange-200 shadow-sm font-bold px-4"
                                                >
                ...
                <Card className="overflow-hidden border border-slate-200 shadow-sm rounded-2xl">
                    ...
                    <CardHeader className="bg-slate-50 border-b border-slate-100 p-8">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <CardTitle className="text-2xl font-bold text-slate-900">Academic Staff Profile</CardTitle>
                        ...
                        <form onSubmit={handleProfileUpdate}>
                            <div className="flex flex-col md:flex-row gap-10 mb-8">
                                <div className="flex flex-col items-center space-y-4 pt-2">
                                    <div className="relative group cursor-pointer" onClick={() => document.getElementById('academic-avatar-upload')?.click()}>
                                        <div className="h-40 w-40 rounded-full bg-orange-100 flex items-center justify-center text-5xl font-bold text-orange-600 border-4 border-white shadow-2xl overflow-hidden relative">
                                            {user.avatar ? (
                                                <img src={user.avatar} alt="Profile" className="h-full w-full object-cover" />
                                            ) : (
                                        ...
                                        <button type="button" className="absolute bottom-2 right-2 p-3 bg-slate-900 text-white rounded-full shadow-lg hover:bg-orange-600 transition-colors border-4 border-white">
                                ...
                                <div className="flex-1 space-y-8">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <Input 
                                                    ...
                                                    className="pl-12 py-6 text-base bg-slate-50 focus:bg-white border-slate-200 focus:ring-orange-500 focus:border-orange-500 rounded-xl" 
                                                />
                                            </div>
                                        </div>
                                        <div>
                                    ...
                                    <div>
                                        ...
                                        <textarea 
                                            rows={4}
                                            className="w-full rounded-xl border border-slate-200 bg-slate-50 focus:bg-white px-4 py-3 text-base text-slate-900 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                            ...
                            <div className="flex justify-end pt-6 border-t border-slate-100">
                                <Button type="submit" className="bg-orange-600 hover:bg-orange-700 text-white px-8 py-4 text-base font-bold rounded-xl shadow-lg shadow-orange-200 transition-transform hover:-translate-y-1" disabled={isSaving}>
                                    {isSaving ? (
                                        <>Saving...</>
                                    ) : (
                    ...
                    <CardContent className="p-8">
                        <form onSubmit={handlePasswordUpdate} className="max-w-2xl">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <Input 
                                            ...
                                            required 
                                            className="py-6 text-base rounded-xl border-slate-200 focus:ring-orange-500 pr-10"
                                        />
                                        <button
                                            type="button"
                            ...
                            <div className="pt-8 mt-4">
                                <Button type="submit" variant="outline" className="border-slate-200 hover:bg-orange-50 hover:text-orange-700 text-base font-bold px-8 py-4 rounded-xl transition-colors" disabled={isSaving}>
                                    Update Password
                                </Button>
                            </div>
                        </form>
                 ...
                 <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                     ...
                     <div className="lg:col-span-2 space-y-8">
                          ...
                          <div className="pt-4">
                                                        ...
                                                        <div className="mt-3 pt-2 border-t border-black/5">
                                                            {comment.attachment.type && comment.attachment.type.startsWith('image/') ? (
                                                                ...
                                                                <div className="bg-white/50 p-2 rounded-lg border border-slate-200/50 flex items-center gap-2 max-w-fit mt-1">
                                                                    ...
                                                                    <a href={comment.attachment.url} download={comment.attachment.name} className="text-xs font-bold text-slate-900 hover:underline hover:text-orange-600 truncate max-w-[200px]">
                              ...
                              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                                  <textarea 
                                     className="w-full bg-white border border-slate-200 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent min-h-[100px] mb-3"
                                  ...
                                  <div className="flex justify-between items-center">
                                      <div className="flex items-center">
                                         <label className="cursor-pointer p-2 text-slate-900 hover:text-orange-600 bg-slate-100 hover:bg-orange-50 rounded-full transition-colors" title="Attach file">
                                         ...
                                         {commentFile && (
                                            <div className="flex items-center gap-2 bg-orange-50 px-3 py-1 rounded-full border border-orange-100 ml-2">
                                                <span className="text-xs font-medium text-orange-700 max-w-[150px] truncate">{commentFile.name}</span>
                                                <button onClick={() => setCommentFile(null)} className="text-orange-500 hover:text-red-500">
                                                    <X className="h-3 w-3" />
                                                </button>
                                            </div>
                                         )}
                     ...
                     <div className="space-y-6">
                             ...
                             <CardContent className="p-4 space-y-4">
                                 <div>
                                     ...
                                     <Select
                                         ...
                                         className="w-full bg-slate-50 border-slate-200 font-medium text-slate-700 rounded-lg focus:ring-orange-500"
                                     >
                         ...
                         <Card className="border border-slate-200 shadow-sm rounded-xl overflow-hidden bg-white">
                             ...
                             <CardContent className="p-4">
                                 <form onSubmit={handleSetAppointment} className="space-y-4">
                                     ...
                                     <Button type="submit" className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold text-xs py-2">
                                         Set Appointment
                                     </Button>
                                 </form>
                             </CardContent>
                         ...
                         <div className="bg-orange-50 border border-orange-100 rounded-xl p-4 flex gap-3">
                             ...
                             <div>
                                 <h4 className="text-sm font-bold text-orange-900 mb-1">Important</h4>
        ...
        >
            {selectedStudent && (
                <div className="space-y-6">
                    <div className="flex items-center space-x-6 mb-8 p-6 bg-gradient-to-r from-orange-600 to-amber-600 rounded-2xl text-white shadow-lg relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-orange-100 opacity-90">{selectedStudent.email}</p>
                        ...
                        <div className="space-y-4 max-h-[50vh] overflow-y-auto pr-2">
                            ...
                            getStudentTickets(selectedStudent.id).map(t => (
                                <div 
                                    ...
                                    className="border border-slate-200 rounded-xl p-5 hover:bg-slate-50 transition-all group bg-white cursor-pointer hover:border-orange-400 hover:shadow-md relative"
                                >
                                    <div className="flex justify-between items-start pr-8">
                                        <div>
                                            <span className="text-xs font-mono text-slate-400 block mb-1">{t.id}</span>
                                            <h5 className="font-bold text-lg text-slate-900 group-hover:text-orange-600 transition-colors">{t.title}</h5>
                                    ...
                                    <div className="absolute right-5 top-1/2 -translate-y-1/2 text-slate-300 group-hover:text-orange-600 opacity-0 group-hover:opacity-100 transition-all">
                            ...
                            <div className="text-center py-12 border-2 border-dashed border-slate-100 rounded-2xl">
                                ...
                                <p className="text-slate-500 font-medium">No academic tickets found for this student.</p>
                            </div>
                        )}
                    </div>
                </div>
